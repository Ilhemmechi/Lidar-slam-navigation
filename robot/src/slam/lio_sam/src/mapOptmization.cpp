...
public:
    ...
    // Correction QoS explicite pour l'odométrie globale (RELIABLE pour compatibilité RViz)
    rclcpp::QoS qos_odom(10);
    qos_odom.reliability(RMW_QOS_POLICY_RELIABILITY_RELIABLE);
    pubLaserOdometryGlobal = create_publisher<nav_msgs::msg::Odometry>("lio_sam/mapping/odometry", qos_odom);
